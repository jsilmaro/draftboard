    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col lg:flex-row transition-colors duration-300">
      ...
      <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <DefaultAvatar name={user?.fullName || user?.userName || 'Creator'} size="sm" className="mr-3" />
            <span className="font-bold text-lg text-gray-900 dark:text-white">{user?.userName || 'Creator'}</span>
          </div>
