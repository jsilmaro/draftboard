            ...
            <div className="space-y-0.5">
              {accountNav.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center justify-center lg:justify-start ${sidebarCollapsed ? 'justify-center p-2' : 'px-4 py-3'} rounded-xl text-sm transition-all duration-300 group ${
                    isDark
