  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={onClose}
                className="text-gray-500 dark:text-gray-400 hover:text-gray-300 dark:hover:text-gray-300 text-xl"
              >
                ✕
              </button>
            </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                {/* Brand Information */}
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-700 dark:border-gray-600">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-700">
                  ...
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border border-green-100 dark:border-green-700">
                      <p className="text-sm text-gray-300 dark:text-gray-400 mb-1">Total Reward</p>
                      <p className="text-2xl font-bold text-green-600 dark:text-green-400">${brief.reward.toLocaleString()}</p>
                                             <p className="text-sm text-gray-300 dark:text-gray-400 mt-1">for {brief.amountOfWinners} reward{brief.amountOfWinners > 1 ? 's' : ''}</p>
                    </div>
                        ...
                        <div className="space-y-3">
                          {brief.rewardTiers.map((tier) => (
                            <div key={tier.position} className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                              ...
                              {tier.creditAmount > 0 && (
                                <p className="text-sm text-gray-300 dark:text-gray-400">+ {tier.creditAmount} credits</p>
                              )}
                              {tier.prizeDescription && (
                                <p className="text-sm text-gray-300 dark:text-gray-400">+ {tier.prizeDescription}</p>
                              )}
                            </div>
                          ))}
                        </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-700">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 dark:text-gray-400">Creators Applied</span>
                      <span className="font-semibold text-white">{brief.submissions.length}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 dark:text-gray-400">Rewards Given</span>
                      <span className="font-semibold text-white">{brief.totalRewardsPaid}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300 dark:text-gray-400">Status</span>
                    ...
                    {brief.location && (
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300 dark:text-gray-400">Location</span>
