    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 fade-in">
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-6 slide-in-up">
            Connect Brands with Creators
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto fade-in-delay-1">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto stagger-children">
          {/* Brand Card */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 card-hover">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">For Brands</h2>
